...
public class SqliteCoverageRepository : ICoverageRepository
{
    private readonly string _connectionString;

    public SqliteCoverageRepository(String connectionString)
    {
...
CREATE TABLE IF NOT EXISTS coverage_unit (
    ...
    private void InsertUri(string uri, string test, SqliteConnection connection)
    {
